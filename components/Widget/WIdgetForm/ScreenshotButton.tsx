...
export const ScreenshotButton = ({ screenshot, onScreenshotTook }: ScreenshotButtonProps) => {
  ...
  if(screenshot) {
    return (
      <button onClick={() => {onScreenshotTook(null)}} type="button" className="p-1 w-10 h-10 rounded-md border-transparent flex justify-end items-end text-zinc-500 hover:text-zinc-800 dark:text-zinc-400 dark:hover:text-zinc-100 transition-colors" style={{
